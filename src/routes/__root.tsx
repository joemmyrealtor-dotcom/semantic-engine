...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    meta: [
      ...
      { title: "Legacy Forge — Real Estate Decision Guides" },
      ...
      { name: "author", content: "Joe Melendez" },
      { name: "robots", content: INTERNAL_ROBOTS },
      { property: "og:site_name", content: BRAND.name },
      { property: "og:title", content: "Legacy Forge" },
      { property: "og:description", content: "Canonical knowledge, governed publishing, and release management for Legacy Forge." },
