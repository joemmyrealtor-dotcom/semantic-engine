...
export const NINETY_DAY_TARGETS: GrowthTarget[] = [
  target(
    ...
    1500,
    "ASSUMPTION",
    "Qualified visitors, not raw sessions. No instrumentation exists for the qualified-visitor definition, so this stays TARGET_ONLY and is never compared to a session count.",
    false,
  ),
